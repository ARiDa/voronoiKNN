...
public class GraphGenerator {
	...
	public CHGraph generateAndorra() {
		...
		String graphHopperAndorraDir = Configuration.USER_HOME + "/graphhopper/experiments/voronoiKNN/andorra";
		String graphastAndorraDir = Configuration.USER_HOME + "/graphast/experiments/voronoiKNN/andorra";
